...
const nuevaString = 'npasdasddasdsa';
...
function combinarNombres(nombre, apellido) {
  ...
  // Ejemplo: "Soy", "Henry" -> "Soy Hennpm test JSI.test.jsry"
  // Tu código:
...
function retornarPerimetro(lado){
  ...
  return retornarPerimetro(lado)=lado*4;
}
...
function deEuroAdolar(euro){
  ...
  //Escribe tu código aquí
  return deEuroAdolar(euro)=deEuroAdolar(euro) * 1.25;
}
